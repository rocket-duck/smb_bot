LINKS = {
    "Доступы": {
        ...
        "subsections": {
            ...
            "ЕКА, Трассировка, Аудит": {
                ...
                "regex": [r"\bека.*", r"\bтрассировка.*", r"\bаудит.*"],
            },
            "Ключ-астром": {
                "key": "key_astrom",
                "url": "https://sfera.inno.local/knowledge/pages?id=1150161",
                "regex": [r"\bключ-астром.*", r"\bключастром.*", r"\bастром.*"],
            },
            "ФРКК": {
                "key": "frkk",
    ...
    "ЕПА": {
        ...
        "subsections": {
            "Авторизация по старой цепочке (ЕПА-3)": {
                ...
                "regex": [r"\bавторизация\b", r"\bепа\b"],
            },
    ...
    "Builder BOT": {
        ...
        "regex": [r"\bвзять сборку\b", r"\bполучить сборку\b", r"\bбрать сборку\b"],
    },
